...
class TestAIGeneratorWithRealAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.api_available = bool(
            config.ANTHROPIC_API_KEY and config.ANTHROPIC_API_KEY.strip()
        )
    ...
    def _create_mock_vector_store(self):
        ...
        mock_results = SearchResults(
            documents=[
                "This is introduction content about getting started with the course"
            ],
    ...
    def test_tool_calling_decision_making(self):
        ...
        self.assertTrue(
            any(
                ...
                for keyword in ["course", "introduction", "ai", "lesson"]
            )
        )
...
class TestAIGeneratorWithMockAPI(unittest.TestCase):
    ...
    def test_system_prompt_structure(self):
        ...
        print(
            f"   Contains tool usage guidelines: {'Tool Usage Guidelines' in system_prompt}"
        )
    ...
    def test_sequential_tool_calling_mock(self, mock_anthropic):
        ...
        mock_final_response.content = [
            Mock(text="Final synthesized response from sequential tool calls")
        ]
        mock_final_response.stop_reason = "end_turn"
        ...
        self.assertEqual(
            response, "Final synthesized response from sequential tool calls"
        )
