...
"""
    ...
    def generate_response(
        ...
        try:
            ...
            return (
                "Unable to synthesize final response. Please try rephrasing your query."
            )

    def _handle_tool_execution_and_continue(
    ...
    def _handle_tool_execution(
        ...
        messages = self._handle_tool_execution_and_continue(
            initial_response, base_params["messages"].copy(), tool_manager
        )
